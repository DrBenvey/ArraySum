...
{
    [Trait("Category", "Unit")]
    public class ArrayStringSumBenchmark
    {
        private readonly ITestOutputHelper _output;

        public ArrayStringSumBenchmark(ITestOutputHelper output)
        {
            _output = output;
        }
        /// <summary>
        ...
        public void TestPerformance_PlainSum_ShouldAllocateNothing()
        {
            ...
            BenchmarkRunner.Run<ArrayStringSumBenchmarkDataPlainSumArray>(config);
        ...
        public void TestPerformance_LinqSumArray_ShouldAllocateNothing()
        {
            ...
            BenchmarkRunner.Run<ArrayStringSumBenchmarkDataLinqSumArray>(config);
        ...
        public void TestPerformance_ParallerSum_ShouldAllocateNothing()
        {
            ...
            BenchmarkRunner.Run<ArrayStringSumBenchmarkDataParallerSum>(config);
